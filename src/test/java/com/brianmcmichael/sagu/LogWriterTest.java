...
public class LogWriterTest {
    ...
    public void getLogFilenamePathShouldConstructCorrectPath() throws Exception {
        ...
        final String separator = getProperty("file.separator");
        when(properties.getDir()).thenReturn(tempDir);
    ...
    public void logUploadedFileShouldWriteCorrectLogs() throws Exception {
        ...
        final List<String> logLines = readAllLines(getLogFile(0, properties).toPath());
        ...
        final List<String> txtLines = readAllLines(getLogFile(1, properties).toPath());
        ...
        final List<String> csvLines = readAllLines(getLogFile(2, properties).toPath());
        ...
        final List<String> yamlLines = readAllLines(getLogFile(3, properties).toPath());
